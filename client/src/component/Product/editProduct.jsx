    ...
    <div className="userPage">
        ...
        <div className="table">
            <h3>
                ...
                <input type="text" placeHolder="Sale..." value={crrProductEdit.bestSeller} onChange={(e)=>setCrrProductEdit({...crrProductEdit, bestSeller: e.target.value})} className="addInput"/>
